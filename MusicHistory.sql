...
DROP TABLE IF EXISTS RecordLable;
...
CREATE TABLE `RecordLable` (
	`RecordLableId` INTEGER NOT NULL PRIMARY KEY autoincrement,
	`RecordLableName` TEXT NOT NULL
);
...
CREATE TABLE `Album` (
	...
	`RecordLableId` INTEGER NOT NULL,
	`ArtistId` INTEGER NOT NULL,
	`GenreId`	INTEGER,
	FOREIGN KEY(`ArtistId`) REFERENCES `Artist`(`ArtistId`),
	FOREIGN KEY(`GenreId`) REFERENCES `Genre`(`GenreId`)
	FOREIGN KEY(`RecordLableId`) references `RecordLable`(`RecordLableId`)
);
...
INSERT INTO RecordLable VALUES (null, 'American');
INSERT INTO RecordLable VALUES (null, 'Def Jam');
INSERT INTO RecordLable VALUES (null, 'Stones Throw');
INSERT INTO RecordLable VALUES (null, 'Parlophone');
INSERT INTO RecordLable VALUES (null, 'Columbia');
INSERT INTO RecordLable VALUES (null, 'Chess');
INSERT INTO RecordLable VALUES (null, 'Warner Bros');
INSERT INTO RecordLable VALUES (null, 'SST');
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, RecordLable rl WHERE a.ArtistName = "Avett Brothers" AND g.Label = "Folk" AND rl.RecordLableName = "American";
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, RecordLable rl WHERE a.ArtistName = "Jay Z" AND g.Label = "Rap" AND rl.RecordLableName = "Def Jam";
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, RecordLable rl WHERE a.ArtistName = "Mayer Hawthorne" AND g.Label = "Soul" AND RecordLableName = "Stones Throw Records";
...
INSERT INTO Album VALUES (null, "Damaged", '12/05/1981', 2098, 8, 8, 9);
INSERT INTO Album VALUES (null, "TV Party", '07/12/1982', 409, 8, 8, 9);
INSERT INTO Album VALUES (null, "Everything Went Black", '12/03/1982', 3718, 8, 8, 9);
